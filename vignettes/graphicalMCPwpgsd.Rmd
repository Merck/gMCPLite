...
fmt_corr <- function(x, title) {
  ...
  xt <- xt %>% dplyr::select(Test, dplyr::everything())
  gt::gt(xt) %>%
...
print(fmt_corr(corr_os_disp, "OS family: correlation matrix for Z statistics (H1/H2 across analyses)"))
print(fmt_corr(corr_pfs_disp, "PFS family: correlation matrix for Z statistics (H3/H4 across analyses; encoded as local H1/H2)"))
...
fmt_corr(corr_all, "Combined correlation matrix (block-diagonal OS + PFS)")
```
