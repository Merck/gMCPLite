...
Here we use information fraction \(t_k = n_k / n_K\) as spending time for each hypothesis (i.e., `info_scale = "h0_info"`), which aligns the sequential p-value calculation with `rpact`.
