...
NOTE THAT SPENDING TIME IS NOT AN OPTION IN rpact; WE WILL USE INFORMATION FRACTION INSTEAD.
...
inputResults <- tibble(
  ...
  # Use information fraction ("h0_info") as spending time for each hypothesis
  spendingTime = c(
