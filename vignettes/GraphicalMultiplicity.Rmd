  ...
  EOCtab$seqp[EOCtabline] <-
    ifelse(is.null(gsDlist[[EOCtabline]]), EOCtab$nominalP[EOCtabline], {
      ...
      gsDesign::sequentialPValue(
        gsD = gsDlist[[EOCtabline]], interval = c(1e-05, .9999),
        n.I = tem$events,
  ...
  if (!is.null(gsDlist[[i]])) {
    ...
    if (EOCtab$lastAlpha[i] > 0) {
      ...
      for (aa in seq_len(n_analyses)) {
        ...
        seq_p_by_analysis[aa] <- gsDesign::sequentialPValue(
          gsD = d, interval = c(1e-05, .9999),
          n.I = n.I,
          Z = z_seq,
          usTime = usTime
        )
        ...
        z_rep[aa] <- all_z[aa]
        rep_p_by_analysis[aa] <- gsDesign::sequentialPValue(
          gsD = d, interval = c(1e-05, .9999),
          n.I = n.I,
          Z = z_rep,
          usTime = usTime
